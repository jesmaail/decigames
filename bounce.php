...
<html>
	...
	<body>
		...
		<div id="content">
			...
			<div id="gameWrapper">
				<div id="selectedGame">
					<div id="game_div" style="width:500px; height:300px;"><!-- Change Game size here -->
						<script src="./games/bounce/Boot.js"></script>
						<script src="./games/bounce/Preloader.js"></script>
						<script src="./games/bounce/Game.js"></script>
						<script src="./games/bounce/Death.js"></script>
						<script>
							var game = new Phaser.Game(500, 300, Phaser.CANVAS, "game_div"); // Phaser engine initialization
