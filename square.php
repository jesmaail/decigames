...
<html>
	...
	<body>
		...
		<div id="content">
			...
			<div id="gameWrapper">
				<div id="selectedGame">
					<div id="game_div" style="width:600px; height:300px;"><!-- Change Game size here -->
						<script src="./games/square/Boot.js"></script>
						<script src="./games/square/Preloader.js"></script>
						<script src="./games/square/Game.js"></script>
						<script src="./games/square/Death.js"></script>
						<script>
							var game = new Phaser.Game(600, 300, Phaser.CANVAS, "game_div"); // Phaser engine initialization
