...
<html>
	...
	<body>
		...
		<div id="content">
			...
			<div id="gameWrapper">
				<div id="selectedGame">
					<div id="game_div" style="width:400px; height:640px;"><!-- Change Game size here -->
						<script src="./games/asteroid/Boot.js"></script>
						<script src="./games/asteroid/Preloader.js"></script>
						<script src="./games/asteroid/Game.js"></script>
						<script src="./games/asteroid/Death.js"></script>
						<script>
							var game = new Phaser.Game(400, 640, Phaser.CANVAS, "game_div"); // Phaser engine initialization
